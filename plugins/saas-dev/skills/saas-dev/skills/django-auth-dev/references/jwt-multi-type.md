...
## Password reset flow (non-primary user types)

See `references/password-reset.md` — full flow with fragment-based token
delivery, single-use tokens, and frontend reading pattern.
